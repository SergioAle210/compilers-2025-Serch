...
class SimpleLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpleLangParser#EqNeq.
    def enterEqNeq(self, ctx:SimpleLangParser.EqNeqContext):
        pass

    # Exit a parse tree produced by SimpleLangParser#EqNeq.
